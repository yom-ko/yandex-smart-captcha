...
- If you modify generated HTML, JS callback payloads, event names, or widget configuration, update the assertions in [test/src/web_smart_captcha_test.dart](../../test/src/web_smart_captcha_test.dart) and the relevant browser adapter contract tests in [test/src/captcha_adapter_controller_web_test.dart](../../test/src/captcha_adapter_controller_web_test.dart).
...
- Making browser tests depend on the real Yandex script or network availability.
